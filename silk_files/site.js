...
(function() {
  ...
  CanvasUtil = (function() {
    ...
    CanvasUtil.prototype.resizeToWindowAndPreserveContents = function() {
      ...
      /* Silk-specific blackness hack — use identity transform for full coverage */
      ctx.save();
  ...
  this.Silks = (function() {
    ...
    Silks.prototype.updateInputFromEvent = function(e) {
      var rect = this.sparksCanvas.getBoundingClientRect();
      var scaleX = this.sparksCanvas._util.widthOnScreen / rect.width;
      var scaleY = this.sparksCanvas._util.heightOnScreen / rect.height;
      this.inputX = (e.clientX - rect.left) * scaleX;
      return this.inputY = (e.clientY - rect.top) * scaleY;
    };
  ...
  $((function(_this) {
    return function() {
      ...
      b = {
        ...
        isFullscreen: ko.observable(!!document.fullscreenElement),
